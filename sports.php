<?php
 ...
 $user_id = $_SESSION['user_id'];
  ...
  $total_amount = 0;
   ...
   $query = mysqli_query($db->connect(), "Select *,(Select SUM(`amount_due`) FROM `sports` WHERE `user_id` = '$user_id') AS total_amount FROM `sports` WHERE `user_id` = '$user_id' AND `amount_due` > 0 GROUP BY `id` ") or die(mysqli_error($db->connect()));
    if ($query) {
        ...
        if ($rows > 0) {
            while ($row = mysqli_fetch_array($query)) {
                ...
                $dataArray['time_reported'] = $time_reported;
                $dataArray['total_amount'] = $total_amount;
...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="col-md-9">	
                        <div class="widget widget-nopad stacked">
                            ...
                            <div class="widget-header">
                                    <i class="icon-book"></i>
                                    <h3>Damaged/Lost Sport Items</h3>
                            </div> <!-- /widget-header -->
                                ...
                                <table class="table table-bordered table-condensed">
                                    ...
                                    for ($j = 0; $j < sizeof($finalArray); $j++){
                                        ...
                                        <tr class="">
                                          ...
                                          <td class="col col-lg-1 "><?php echo $finalArray[$j]["time_reported"]?></td>
                                       </tr>
                                    <?php }?>
                                    </tbody>
        ...
        <script src="./js/sports_payment.js"></script>
