...
if (isset($_POST['reg_no']) && isset($_POST['password'])) {
    ...
    if (!empty($reg_no) && !empty($password)) {
        ...
        $queryresult = mysqli_query($db->connect(), "SELECT * FROM `user` WHERE `reg_no`='$reg_no' AND `password`='$password' ");
                ...
                <form action="login.php" method="POST">
                    ...
                    <div class="login-fields">
                        ...
                        <div class="field">
                            ...
                            <input type="text" id="reg_no" name="reg_no" value="" placeholder="Admission Number" class="form-control input-lg username-field" />
                        </div> <!-- /field -->
