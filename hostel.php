    ...
    <body>
        ...
        <div class="main">
                                 ...
                                 <table class="table  table-bordered">
                                    ...
                                    for ($j = 0; $j < sizeof($finalArray); $j++){
                                        ...
                                        <tr class="">
                                           ...
                                           <td class="col col-lg-1 "><?php echo $finalArray[$j]["academic_year"]?></td>
                                           <td class="col col-lg-1 "><?php echo $finalArray[$j]["sem"]?></td>
                                            <td class="col col-lg-1 "><?php echo $finalArray[$j]["room_no"]?></td>
                                           <td class="col col-lg-1 "><?php echo $finalArray[$j]["space_no"]?></td>
			...
			<div class="widget widget-plain">
                            <div class="widget-content">
                                <span class="btn btn-default btn-support-ask" id="amount" data="<?php echo $total_amount; ?>">Balance: Ksh <?php echo $total_amount; ?></span>
